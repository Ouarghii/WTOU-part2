...
Dialog20::Dialog20(QWidget *parent,int s) :
    QDialog(parent),
    ui(new Ui::Dialog20)
{
    ui->setupUi(this);
...
void Dialog20::on_pushButton_clicked()
{
    ...
    dia = new Dialog21(this,s31);
    hide();
    dia ->show();
}


void Dialog20::on_pushButton_2_clicked()
{
...
void Dialog20::on_pushButton_3_clicked()
{
    QMessageBox::information(this,"answer","wrong answer");
...
void Dialog20::on_pushButton_4_clicked()
{
    QMessageBox::information(this,"answer","wrong answer");

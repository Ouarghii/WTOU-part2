...
Dialog15::Dialog15(QWidget *parent,int s) :
    QDialog(parent),
    ui(new Ui::Dialog15)
{
    ui->setupUi(this);
...
void Dialog15::on_pushButton_2_clicked()
{
...
void Dialog15::on_pushButton_3_clicked()
{
    QMessageBox::information(this,"answer","wrong answer");
...
void Dialog15::on_pushButton_4_clicked()
{
    QMessageBox::information(this,"answer","wrong answer");

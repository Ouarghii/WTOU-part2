#include "dialog25.h"
#include "ui_dialog25.h"
#include "dialog26.h"
#include <QMessageBox>
#include <QVBoxLayout>
Dialog25::Dialog25(QWidget *parent,int s) :
    QDialog(parent),
    ui(new Ui::Dialog25)
{
    ui->setupUi(this);
...
void Dialog25::on_pushButton_4_clicked()
{
    QMessageBox::information(this,"answer","Wrong answer");

    dia = new Dialog26(this,s36);
    hide();
    dia ->show();
}


void Dialog25::on_pushButton_2_clicked()
{
...
void Dialog25::on_pushButton_clicked()
{
    QMessageBox::information(this,"answer","Wrong answer");
...
void Dialog25::on_pushButton_3_clicked()
{
    QMessageBox::information(this,"answer","Wrong answer");
